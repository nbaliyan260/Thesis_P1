...
|---|---:|---|---:|---:|---:|---:|---:|---:|
| HuggingFaceTB/SmolLM2-135M | 3 | sparse | 1.154 | 13.5 | 0.177 | 33.437 | 0.0053 | undefined |
| HuggingFaceTB/SmolLM2-135M | 3 | all | 1.486 | 130.5 | 1.669 | 50.725 | 0.0329 | 0.0189 |
| Qwen/Qwen2.5-0.5B | 3 | sparse | 1.301 | 21.0 | 0.717 | 31.611 | 0.0227 | 0.0227 |
| Qwen/Qwen2.5-0.5B | 3 | all | 1.751 | 161.0 | 4.275 | 44.834 | 0.0953 | 0.0953 |
...
- HuggingFaceTB/SmolLM2-135M: sparse-minus-all median recovery difference 22.975 ms; median payload ratio 0.103; sparse repair medians lower/equal/higher in 0/0/3 cases; observed repair ranges overlap in 0/3 cases.
- Qwen/Qwen2.5-0.5B: sparse-minus-all median recovery difference 19.763 ms; median payload ratio 0.130; sparse repair medians lower/equal/higher in 0/0/3 cases; observed repair ranges overlap in 0/3 cases.
